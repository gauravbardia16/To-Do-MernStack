...
const TodoList = () => {
    ...
    const handleAddTask = async (name)=>{
        const url="http://localhost:5000/addtasks";
        const data = {
            task_desc:name
        };
        const options={
    ...
    const handleStatusChange = async (taskID)=>{
        const url="http://localhost:5000/updatetasks";
        const data = {
            taskid:taskID
        };
        const options={
    ...
    const handleDelete = async (taskID)=>{
        const url="http://localhost:5000/deletetask";
        const data = {
            taskid:taskID
        };
        const options={
    ...
    const renderPending = ()=>{
        return (
            <>
            <h1 style={{ color: "#784caf", fontSize: "28px", textAlign: "left" }}>
              Pending Tasks
            </h1>
